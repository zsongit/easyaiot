...
#### 注意：百级以上摄像头接入需要使用Kubernetes云原生编程、NVIDIA GPU编解码加速、RK3588 NPU加速等，会大大增加开源项目复杂性与开源理念相悖，所以针对百级以上摄像头场景，放到姊妹项目MegAIoT + 模方开放平台，拆分的目的是将基础架构平台与垂直领域解决方案分离，实现5分钟部署，1小时定制。
