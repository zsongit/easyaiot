...
typedef void (*MppDecoderFrameCallback)(void* userdata, int width_stride, int height_stride, int width, int height, int format, int fd, void* data, int input_id);
...
public:
    ...
    MppDecoder();
    ~MppDecoder();
    int Init(int video_type, int fps, void* userdata, int camera_id);
